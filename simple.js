...
var _Bogdanp$elm_datepicker$Simple$formatDate = function (d) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(
			_elm_lang$core$Date$month(d)),
...
var _Bogdanp$elm_datepicker$Simple$Model = F2(
	function (a, b) {
		return {date: a, datePicker: b};
	});
var _Bogdanp$elm_datepicker$Simple$ToDatePicker = function (a) {
	return {ctor: 'ToDatePicker', _0: a};
};
var _Bogdanp$elm_datepicker$Simple$init = function () {
	var isDisabled = function (date) {
		return A2(
			_elm_lang$core$List$member,
			_elm_lang$core$Date$dayOfWeek(date),
			_elm_lang$core$Native_List.fromArray(
				[_elm_lang$core$Date$Sat, _elm_lang$core$Date$Sun]));
	};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$core$Platform_Cmd$map, _Bogdanp$elm_datepicker$Simple$ToDatePicker, datePickerFx)
			]));
}();
var _Bogdanp$elm_datepicker$Simple$update = F2(
	function (msg, _p1) {
		var _p2 = _p1;
		var _p6 = _p2;
		var _p3 = msg;
		var _p4 = A2(_Bogdanp$elm_datepicker$DatePicker$update, _p3._0, _p2.datePicker);
...
var _Bogdanp$elm_datepicker$Simple$view = function (_p7) {
	var _p8 = _p7;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
				...
				if (_p9.ctor === 'Nothing') {
					...
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								_Bogdanp$elm_datepicker$Simple$formatDate(_p9._0))
							]));
				}
			}(),
				A2(
				_elm_lang$html$Html_App$map,
				_Bogdanp$elm_datepicker$Simple$ToDatePicker,
				_Bogdanp$elm_datepicker$DatePicker$view(_p8.datePicker))
			]));
};
var _Bogdanp$elm_datepicker$Simple$main = {
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['Simple'], 'Simple', typeof _Bogdanp$elm_datepicker$Simple$main === 'undefined' ? null : _Bogdanp$elm_datepicker$Simple$main);
